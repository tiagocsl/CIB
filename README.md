...
![img](https://github.com/tiagocsl/CIB/blob/master/files/images/rfid.png)
...
![img](https://github.com/tiagocsl/CIB/blob/master/files/images/rfid-ping.png)
...
![img](https://github.com/tiagocsl/CIB/blob/master/files/images/rfid-pong.png)
...
![img](https://github.com/tiagocsl/CIB/blob/master/files/images/nodemcu-rfid.png)
...
const mqttConfig = {
    broker: 'broker.hivemq.com', // url do broker
    topic: '/cib/entrada/ReceptorDeTags', // topico ouvinte
    port: 8000 // porta referente ao WebSockets do Broker
};
...
DB_HOST=localhost // ip/host do Mysql
DB_DATABASE=cib // nome dado ao banco de dados
DB_USER=tiago // usuário do banco de dados
DB_PASS=cib12345 // senha do banco de dados

BROKER_HOST=broker.hivemq.com // ip/host do broker
